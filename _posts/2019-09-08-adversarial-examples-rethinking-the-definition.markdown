...
<div class="img_container">
    <p>
        <img src="/assets/advx_definition/advx_example.png" >
        <div>Original image (left), adversarial noise (middle), perturbed image incorrectly classified as a 2 (right)</div>
    </p>
</div>
...
<div class="img_container">
    <p>
        <img src="/assets/advx_definition/dist_heatmap_l2.png" >
        <div>L-2 Norm Training Set Distances</div>
    </p>
</div>
...
<div class="img_container">
    <p>
        <img src="/assets/advx_definition/eps03.png" >
        <div>Crafted image within ε=0.3 L-inf distance of original</div>
    </p>
</div>
...
<div class="img_container">
    <p>
        <img src="/assets/advx_definition/triplet.png" >
        <div>Illustration of a what a triplet network does</div>
    </p>
</div>
